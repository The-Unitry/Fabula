...
public class UNGameScreen extends UNObject
{
    ...
    public void preload()
    {
        ...
        try
        {
            ...
            //LEVEL3
            sprites.add(40, ImageIO.read(new File("res/sprites/moon0.png")));
            sprites.add(41, ImageIO.read(new File("res/sprites/moon1.png")));
            sprites.add(42, ImageIO.read(new File("res/sprites/rocket0.png")));
            sprites.add(43, ImageIO.read(new File("res/sprites/rocket1.png")));
            sprites.add(44, ImageIO.read(new File("res/sprites/rocket2.png")));
            sprites.add(45, ImageIO.read(new File("res/sprites/rocket3.png")));
